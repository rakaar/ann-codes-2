function [finished_stim,Femto_Behaviour_params]=prairie_FBAud_struct(Femto_Behaviour_params,PP_handles)
...
IMG.frames_lines_per_iter=stim_structureAUD.stim_protocol.total_frames; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
total_line_duration=stim_structureAUD.stim_protocol.total_frames;
...
%         stimulus=stimulus*HW.Amplitude;
    ...
    started=0;
    load interrupt_aud
    if interrupt_aud==0 | interrupt_FB==0
        ...
        STIMULUSO=[zeros(Reward_samp,1);stimuO'];
