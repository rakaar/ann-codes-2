...
% Last Modified by GUIDE v2.5 28-Sep-2014 12:37:07
...
set(handles.stim_gap_check,'Value',EstimPARAMS.stim_gap_check);
eval(sprintf('set(handles.stim_gap,''String'',''%i'');',EstimPARAMS.stim_gap_val))
...
EstimPARAMS.stim_gap_val=str2double(get(hObject,'String')) %returns contents of num_pt_val as a double
set(handles.stim_gap,'Value',EstimPARAMS.stim_gap_val);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save EstimPARAMS EstimPARAMS
cd (curdir)
...
load EstimPARAMS
EstimPARAMS.stim_gap_check=get(hObject,'Value');
set(handles.stim_gap_check,'Value',EstimPARAMS.stim_gap_check);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save EstimPARAMS EstimPARAMS
