...
%This function was generated by the perl file prototypes.pl called from loadlibary.m on Tue Dec 24 11:30:06 2002
...
fcns.name{2}='AI_Check'; fcns.calltype{2}='stdcall'; fcns.LHS{2}='int16'; fcns.RHS{2}={'int16', 'int16Ref', 'int16Ref'};
...
fcns.name{6}='AI_Read'; fcns.calltype{6}='stdcall'; fcns.LHS{6}='int16'; fcns.RHS{6}={'int16', 'int16', 'int16', 'int16Ref'};
%  extern i16 _stdcall AI_Read32 ( i16 slot, i16 chan, i16 gain, i32 * value); 
fcns.name{7}='AI_Read32'; fcns.calltype{7}='stdcall'; fcns.LHS{7}='int16'; fcns.RHS{7}={'int16', 'int16', 'int16', 'int32Ref'};
...
fcns.name{9}='AI_VRead'; fcns.calltype{9}='stdcall'; fcns.LHS{9}='int16'; fcns.RHS{9}={'int16', 'int16', 'int16', 'doubleRef'};
%  extern i16 _stdcall AI_VScale ( i16 slot, i16 chan, i16 gain, f64 gainAdjust, f64 offset, i16 reading, f64 * voltage); 
fcns.name{10}='AI_VScale'; fcns.calltype{10}='stdcall'; fcns.LHS{10}='int16'; fcns.RHS{10}={'int16', 'int16', 'int16', 'double', 'double', 'int16', 'doubleRef'};
%  extern i16 _stdcall Align_DMA_Buffer ( i16 slot, i16 resource, i16 * buffer, u32 cnt, u32 bufSize, u32 * alignIndex); 
fcns.name{11}='Align_DMA_Buffer'; fcns.calltype{11}='stdcall'; fcns.LHS{11}='int16'; fcns.RHS{11}={'int16', 'int16', 'int16Ref', 'uint32', 'uint32', 'uint32Ref'};
...
fcns.name{21}='Config_Alarm_Deadband'; fcns.calltype{21}='stdcall'; fcns.LHS{21}='int16'; fcns.RHS{21}={'int16', 'int16', 'int8Ref', 'double', 'double', 'voidRef', 'int16', 'int16', 'uint32'};
...
fcns.name{22}='Config_ATrig_Event_Message'; fcns.calltype{22}='stdcall'; fcns.LHS{22}='int16'; fcns.RHS{22}={'int16', 'int16', 'int8Ref', 'double', 'double', 'int16', 'uint32', 'uint32', 'uint32', 'voidRef', 'int16', 'uint32'};
...
fcns.name{23}='Config_DAQ_Event_Message'; fcns.calltype{23}='stdcall'; fcns.LHS{23}='int16'; fcns.RHS{23}={'int16', 'int16', 'int8Ref', 'int16', 'int32', 'int32', 'uint32', 'uint32', 'uint32', 'voidRef', 'int16', 'uint32'};
...
fcns.name{27}='CTR_EvRead'; fcns.calltype{27}='stdcall'; fcns.LHS{27}='int16'; fcns.RHS{27}={'int16', 'int16', 'int16Ref', 'uint16Ref'};
...
fcns.name{31}='CTR_Rate'; fcns.calltype{31}='stdcall'; fcns.LHS{31}='int16'; fcns.RHS{31}={'double', 'double', 'int16Ref', 'uint16Ref', 'uint16Ref'};
...
fcns.name{34}='CTR_Simul_Op'; fcns.calltype{34}='stdcall'; fcns.LHS{34}='int16'; fcns.RHS{34}={'int16', 'int16', 'int16Ref', 'int16'};
...
fcns.name{36}='CTR_State'; fcns.calltype{36}='stdcall'; fcns.LHS{36}='int16'; fcns.RHS{36}={'int16', 'int16', 'int16Ref'};
...
fcns.name{38}='DAQ_Check'; fcns.calltype{38}='stdcall'; fcns.LHS{38}='int16'; fcns.RHS{38}={'int16', 'int16Ref', 'uint32Ref'};
...
fcns.name{42}='DAQ_DB_HalfReady'; fcns.calltype{42}='stdcall'; fcns.LHS{42}='int16'; fcns.RHS{42}={'int16', 'int16Ref', 'int16Ref'};
%  extern i16 _stdcall DAQ_DB_Transfer ( i16 slot, i16 * hbuffer, u32 * ptsTfr, i16 * status); 
fcns.name{43}='DAQ_DB_Transfer'; fcns.calltype{43}='stdcall'; fcns.LHS{43}='int16'; fcns.RHS{43}={'int16', 'int16Ref', 'uint32Ref', 'int16Ref'};
%  extern i16 _stdcall DAQ_Monitor ( i16 slot, i16 chan, i16 seq, u32 monitorCnt, i16 * monitorBuf, u32 * newestIndex, i16 * status); 
fcns.name{44}='DAQ_Monitor'; fcns.calltype{44}='stdcall'; fcns.LHS{44}='int16'; fcns.RHS{44}={'int16', 'int16', 'int16', 'uint32', 'int16Ref', 'uint32Ref', 'int16Ref'};
%  extern i16 _stdcall DAQ_Op ( i16 slot, i16 chan, i16 gain, i16 * buffer, u32 cnt, f64 sampleRate); 
fcns.name{45}='DAQ_Op'; fcns.calltype{45}='stdcall'; fcns.LHS{45}='int16'; fcns.RHS{45}={'int16', 'int16', 'int16', 'int16Ref', 'uint32', 'double'};
%  extern i16 _stdcall DAQ_Rate ( f64 rate, i16 units, i16 * timebase, u16 * sampleInt); 
fcns.name{46}='DAQ_Rate'; fcns.calltype{46}='stdcall'; fcns.LHS{46}='int16'; fcns.RHS{46}={'double', 'int16', 'int16Ref', 'uint16Ref'};
%  extern i16 _stdcall DAQ_Start ( i16 slot, i16 chan, i16 gain, i16 * buffer, u32 cnt, i16 timebase, u16 sampInt); 
fcns.name{47}='DAQ_Start'; fcns.calltype{47}='stdcall'; fcns.LHS{47}='int16'; fcns.RHS{47}={'int16', 'int16', 'int16', 'int16Ref', 'uint32', 'int16', 'uint16'};
...
fcns.name{49}='DAQ_to_Disk'; fcns.calltype{49}='stdcall'; fcns.LHS{49}='int16'; fcns.RHS{49}={'int16', 'int16', 'int16', 'int8Ref', 'uint32', 'double', 'int16'};
%  extern i16 _stdcall DAQ_VScale ( i16 slot, i16 chan, i16 gain, f64 gainAdjust, f64 offset, u32 cnt, i16 * binArray, f64 * voltArray); 
fcns.name{50}='DAQ_VScale'; fcns.calltype{50}='stdcall'; fcns.LHS{50}='int16'; fcns.RHS{50}={'int16', 'int16', 'int16', 'double', 'double', 'uint32', 'int16Ref', 'doubleRef'};
%  extern i16 _stdcall DIG_Block_Check ( i16 slot, i16 grp, u32 * remaining); 
fcns.name{51}='DIG_Block_Check'; fcns.calltype{51}='stdcall'; fcns.LHS{51}='int16'; fcns.RHS{51}={'int16', 'int16', 'uint32Ref'};
...
fcns.name{53}='DIG_Block_In'; fcns.calltype{53}='stdcall'; fcns.LHS{53}='int16'; fcns.RHS{53}={'int16', 'int16', 'int16Ref', 'uint32'};
%  extern i16 _stdcall DIG_Block_Out ( i16 slot, i16 grp, i16 * buffer, u32 cnt); 
fcns.name{54}='DIG_Block_Out'; fcns.calltype{54}='stdcall'; fcns.LHS{54}='int16'; fcns.RHS{54}={'int16', 'int16', 'int16Ref', 'uint32'};
...
fcns.name{57}='DIG_DB_HalfReady'; fcns.calltype{57}='stdcall'; fcns.LHS{57}='int16'; fcns.RHS{57}={'int16', 'int16', 'int16Ref'};
%  extern i16 _stdcall DIG_DB_Transfer ( i16 slot, i16 grp, i16 * halfBuffer, u32 ptsTfr); 
fcns.name{58}='DIG_DB_Transfer'; fcns.calltype{58}='stdcall'; fcns.LHS{58}='int16'; fcns.RHS{58}={'int16', 'int16', 'int16Ref', 'uint32'};
...
fcns.name{61}='DIG_Grp_Status'; fcns.calltype{61}='stdcall'; fcns.LHS{61}='int16'; fcns.RHS{61}={'int16', 'int16', 'int16Ref'};
%  extern i16 _stdcall DIG_In_Grp ( i16 slot, i16 grp, i16 * grp_pat); 
fcns.name{62}='DIG_In_Grp'; fcns.calltype{62}='stdcall'; fcns.LHS{62}='int16'; fcns.RHS{62}={'int16', 'int16', 'int16Ref'};
%  extern i16 _stdcall DIG_In_Line ( i16 slot, i16 port, i16 linenum, i16 * state); 
fcns.name{63}='DIG_In_Line'; fcns.calltype{63}='stdcall'; fcns.LHS{63}='int16'; fcns.RHS{63}={'int16', 'int16', 'int16', 'int16Ref'};
...
fcns.name{65}='DIG_In_Port_GFS'; fcns.calltype{65}='stdcall'; fcns.LHS{65}='int16'; fcns.RHS{65}={'int16', 'int16', 'int16Ref'};
%  extern i16 _stdcall DIG_In_Port ( i16 slot, i16 port, i16 * pattern); 
fcns.name{66}='DIG_In_Port'; fcns.calltype{66}='stdcall'; fcns.LHS{66}='int16'; fcns.RHS{66}={'int16', 'int16', 'int16Ref'};
...
fcns.name{73}='DIG_Prt_Status'; fcns.calltype{73}='stdcall'; fcns.LHS{73}='int16'; fcns.RHS{73}={'int16', 'int16', 'int16Ref'};
%  extern i16 _stdcall DIG_SCAN_Setup ( i16 slot, i16 grp, i16 numPorts, i16 * portList, i16 direction); 
fcns.name{74}='DIG_SCAN_Setup'; fcns.calltype{74}='stdcall'; fcns.LHS{74}='int16'; fcns.RHS{74}={'int16', 'int16', 'int16', 'int16Ref', 'int16'};
%  extern i16 _stdcall Get_DAQ_Device_Info ( i16 deviceNumber, u32 infoType, u32 * infoVal); 
fcns.name{75}='Get_DAQ_Device_Info'; fcns.calltype{75}='stdcall'; fcns.LHS{75}='int16'; fcns.RHS{75}={'int16', 'uint32', 'uint32Ref'};
%  extern i16 _stdcall Get_NI_DAQ_Version ( u32 * version); 
fcns.name{76}='Get_NI_DAQ_Version'; fcns.calltype{76}='stdcall'; fcns.LHS{76}='int16'; fcns.RHS{76}={'uint32Ref'};
%  extern i16 _stdcall GPCTR_Config_Buffer ( i16 deviceNumber, u32 gpCounterNumber, u32 reserved, u32 numPoints, u32 * buffer); 
fcns.name{77}='GPCTR_Config_Buffer'; fcns.calltype{77}='stdcall'; fcns.LHS{77}='int16'; fcns.RHS{77}={'int16', 'uint32', 'uint32', 'uint32', 'uint32Ref'};
...
fcns.name{78}='GPCTR_Read_Buffer'; fcns.calltype{78}='stdcall'; fcns.LHS{78}='int16'; fcns.RHS{78}={'int16', 'uint32', 'uint32', 'int32', 'uint32', 'double', 'uint32Ref', 'uint32Ref'};
...
fcns.name{82}='GPCTR_Watch'; fcns.calltype{82}='stdcall'; fcns.LHS{82}='int16'; fcns.RHS{82}={'int16', 'uint32', 'uint32', 'uint32Ref'};
%  extern i16 _stdcall ICTR_Read ( i16 slot, i16 counter, u16 * cnt); 
fcns.name{83}='ICTR_Read'; fcns.calltype{83}='stdcall'; fcns.LHS{83}='int16'; fcns.RHS{83}={'int16', 'int16', 'uint16Ref'};
...
fcns.name{86}='Init_DA_Brds'; fcns.calltype{86}='stdcall'; fcns.LHS{86}='int16'; fcns.RHS{86}={'int16', 'int16Ref'};
%  extern i16 _stdcall Lab_ISCAN_Check ( i16 slot, i16 * status, u32 * retrieved, i16 * finalScanOrder); 
fcns.name{87}='Lab_ISCAN_Check'; fcns.calltype{87}='stdcall'; fcns.LHS{87}='int16'; fcns.RHS{87}={'int16', 'int16Ref', 'uint32Ref', 'int16Ref'};
...
fcns.name{88}='Lab_ISCAN_Op'; fcns.calltype{88}='stdcall'; fcns.LHS{88}='int16'; fcns.RHS{88}={'int16', 'int16', 'int16', 'int16Ref', 'uint32', 'double', 'double', 'int16Ref'};
...
fcns.name{89}='Lab_ISCAN_Start'; fcns.calltype{89}='stdcall'; fcns.LHS{89}='int16'; fcns.RHS{89}={'int16', 'int16', 'int16', 'int16Ref', 'uint32', 'int16', 'uint16', 'uint16'};
...
fcns.name{90}='Lab_ISCAN_to_Disk'; fcns.calltype{90}='stdcall'; fcns.LHS{90}='int16'; fcns.RHS{90}={'int16', 'int16', 'int16', 'int8Ref', 'uint32', 'double', 'double', 'int16'};
...
fcns.name{98}='SCAN_Demux'; fcns.calltype{98}='stdcall'; fcns.LHS{98}='int16'; fcns.RHS{98}={'int16Ref', 'uint32', 'int16', 'int16'};
%  extern i16 _stdcall SCAN_Op ( i16 slot, i16 numChans, i16 * chans, i16 * gains, i16 * buffer, u32 cnt, f64 sampleRate, f64 scanRate); 
fcns.name{99}='SCAN_Op'; fcns.calltype{99}='stdcall'; fcns.LHS{99}='int16'; fcns.RHS{99}={'int16', 'int16', 'int16Ref', 'int16Ref', 'int16Ref', 'uint32', 'double', 'double'};
...
fcns.name{100}='SCAN_Sequence_Demux'; fcns.calltype{100}='stdcall'; fcns.LHS{100}='int16'; fcns.RHS{100}={'int16', 'int16Ref', 'uint32', 'int16Ref', 'int16', 'int16Ref', 'uint32Ref'};
%  extern i16 _stdcall SCAN_Sequence_Retrieve ( i16 deviceNumber, i16 samplesPerSequence, i16 * scanSequenceVector); 
fcns.name{101}='SCAN_Sequence_Retrieve'; fcns.calltype{101}='stdcall'; fcns.LHS{101}='int16'; fcns.RHS{101}={'int16', 'int16', 'int16Ref'};
...
fcns.name{102}='SCAN_Sequence_Setup'; fcns.calltype{102}='stdcall'; fcns.LHS{102}='int16'; fcns.RHS{102}={'int16', 'int16', 'int16Ref', 'int16Ref', 'int16Ref', 'int16Ref', 'int16Ref'};
%  extern i16 _stdcall SCAN_Setup ( i16 slot, i16 num_chans, i16 * chans, i16 * gains); 
fcns.name{103}='SCAN_Setup'; fcns.calltype{103}='stdcall'; fcns.LHS{103}='int16'; fcns.RHS{103}={'int16', 'int16', 'int16Ref', 'int16Ref'};
%  extern i16 _stdcall SCAN_Start ( i16 slot, i16 * buffer, u32 cnt, i16 tb1, u16 si1, i16 tb2, u16 si2); 
fcns.name{104}='SCAN_Start'; fcns.calltype{104}='stdcall'; fcns.LHS{104}='int16'; fcns.RHS{104}={'int16', 'int16Ref', 'uint32', 'int16', 'uint16', 'int16', 'uint16'};
...
fcns.name{105}='SCAN_to_Disk'; fcns.calltype{105}='stdcall'; fcns.LHS{105}='int16'; fcns.RHS{105}={'int16', 'int16', 'int16Ref', 'int16Ref', 'int8Ref', 'uint32', 'double', 'double', 'int16'};
...
fcns.name{107}='SCXI_AO_Write'; fcns.calltype{107}='stdcall'; fcns.LHS{107}='int16'; fcns.RHS{107}={'int16', 'int16', 'int16', 'int16', 'int16', 'double', 'int16', 'int16Ref'};
...
fcns.name{108}='SCXI_Cal_Constants'; fcns.calltype{108}='stdcall'; fcns.LHS{108}='int16'; fcns.RHS{108}={'int16', 'int16', 'int16', 'int16', 'int16', 'int16', 'double', 'int16', 'int16', 'int16', 'double', 'double', 'double', 'double', 'double', 'doubleRef', 'doubleRef'};
...
fcns.name{109}='InitChannelWizardStrainCal'; fcns.calltype{109}='stdcall'; fcns.LHS{109}='int16'; fcns.RHS{109}={'int16', 'int16', 'int16', 'int16', 'single', 'single', 'doubleRef', 'int16Ref', 'int16Ref', 'single', 'int16'};
...
fcns.name{110}='ChannelWizardSCXIStrainCal'; fcns.calltype{110}='stdcall'; fcns.LHS{110}='int16'; fcns.RHS{110}={'int16', 'int16', 'int16', 'int16', 'int16', 'double', 'int16', 'uint8', 'uint8', 'doubleRef', 'doubleRef', 'doubleRef'};
...
fcns.name{113}='SCXI_Strain_Null'; fcns.calltype{113}='stdcall'; fcns.LHS{113}='int16'; fcns.RHS{113}={'int16', 'int16', 'int16', 'int16', 'int16', 'singleRef'};
...
fcns.name{114}='SCXI_Strain_Null_Ex'; fcns.calltype{114}='stdcall'; fcns.LHS{114}='int16'; fcns.RHS{114}={'int16', 'int16', 'int16', 'int16', 'int16', 'singleRef', 'single', 'uint32', 'int16Ref', 'int16Ref'};
...
fcns.name{118}='SCXI_Set_Excitation'; fcns.calltype{118}='stdcall'; fcns.LHS{118}='int16'; fcns.RHS{118}={'int16', 'int16', 'int16', 'int16', 'single', 'singleRef'};
...
fcns.name{120}='SCXI_Configure_Filter'; fcns.calltype{120}='stdcall'; fcns.LHS{120}='int16'; fcns.RHS{120}={'int16', 'int16', 'int16', 'int16', 'double', 'uint16', 'uint16', 'doubleRef'};
...
fcns.name{121}='SCXI_Get_Chassis_Info'; fcns.calltype{121}='stdcall'; fcns.LHS{121}='int16'; fcns.RHS{121}={'int16', 'int16Ref', 'int16Ref', 'int16Ref', 'int16Ref', 'int16Ref'};
%  extern i16 _stdcall SCXI_Get_Module_Info ( i16 chassisID, i16 slot, i32 * modulePresent, i16 * opMode, i16 * DAQboard); 
fcns.name{122}='SCXI_Get_Module_Info'; fcns.calltype{122}='stdcall'; fcns.LHS{122}='int16'; fcns.RHS{122}={'int16', 'int16', 'int32Ref', 'int16Ref', 'int16Ref'};
%  extern i16 _stdcall SCXI_Get_State ( i16 chassisID, i16 moduleSlot, i16 port, i16 channel, u32 * data); 
fcns.name{123}='SCXI_Get_State'; fcns.calltype{123}='stdcall'; fcns.LHS{123}='int16'; fcns.RHS{123}={'int16', 'int16', 'int16', 'int16', 'uint32Ref'};
%  extern i16 _stdcall SCXI_Get_Status ( i16 chassisID, i16 moduleSlot, i16 wait, u32 * data); 
fcns.name{124}='SCXI_Get_Status'; fcns.calltype{124}='stdcall'; fcns.LHS{124}='int16'; fcns.RHS{124}={'int16', 'int16', 'int16', 'uint32Ref'};
...
fcns.name{128}='SCXI_Scale'; fcns.calltype{128}='stdcall'; fcns.LHS{128}='int16'; fcns.RHS{128}={'int16', 'int16', 'int16', 'double', 'double', 'int16', 'int16', 'int16', 'uint32', 'int16Ref', 'doubleRef'};
...
fcns.name{129}='SCXI_SCAN_Setup'; fcns.calltype{129}='stdcall'; fcns.LHS{129}='int16'; fcns.RHS{129}={'int16', 'int16', 'int16Ref', 'int16Ref', 'int16Ref', 'int16', 'int16'};
...
fcns.name{130}='SCXI_Set_Config'; fcns.calltype{130}='stdcall'; fcns.LHS{130}='int16'; fcns.RHS{130}={'int16', 'int16', 'int16', 'int16', 'int16', 'int16', 'int32Ref', 'int16Ref', 'int16Ref'};
...
fcns.name{141}='WFM_Check'; fcns.calltype{141}='stdcall'; fcns.LHS{141}='int16'; fcns.RHS{141}={'int16', 'int16', 'int16Ref', 'uint32Ref', 'uint32Ref'};
...
fcns.name{143}='WFM_DB_Config'; fcns.calltype{143}='stdcall'; fcns.LHS{143}='int16'; fcns.RHS{143}={'int16', 'int16', 'int16Ref', 'int16', 'int16', 'int16'};
%  extern i16 _stdcall WFM_DB_HalfReady ( i16 slot, i16 numChans, i16 * chanVect, i16 * halfReady); 
fcns.name{144}='WFM_DB_HalfReady'; fcns.calltype{144}='stdcall'; fcns.LHS{144}='int16'; fcns.RHS{144}={'int16', 'int16', 'int16Ref', 'int16Ref'};
%  extern i16 _stdcall WFM_DB_Transfer ( i16 slot, i16 numChans, i16 * chanVect, i16 * buffer, u32 cnt); 
fcns.name{145}='WFM_DB_Transfer'; fcns.calltype{145}='stdcall'; fcns.LHS{145}='int16'; fcns.RHS{145}={'int16', 'int16', 'int16Ref', 'int16Ref', 'uint32'};
...
fcns.name{146}='WFM_from_Disk'; fcns.calltype{146}='stdcall'; fcns.LHS{146}='int16'; fcns.RHS{146}={'int16', 'int16', 'int16Ref', 'int8Ref', 'uint32', 'uint32', 'uint32', 'double'};
...
fcns.name{148}='WFM_Group_Setup'; fcns.calltype{148}='stdcall'; fcns.LHS{148}='int16'; fcns.RHS{148}={'int16', 'int16', 'int16Ref', 'int16'};
%  extern i16 _stdcall WFM_Load ( i16 slot, i16 numChans, i16 * chanVect, i16 * buffer, u32 cnt, u32 iterations, i16 mode); 
fcns.name{149}='WFM_Load'; fcns.calltype{149}='stdcall'; fcns.LHS{149}='int16'; fcns.RHS{149}={'int16', 'int16', 'int16Ref', 'int16Ref', 'uint32', 'uint32', 'int16'};
%  extern i16 _stdcall WFM_Op ( i16 slot, i16 numChans, i16 * chanVect, i16 * buffer, u32 cnt, u32 iterations, f64 rate); 
fcns.name{150}='WFM_Op'; fcns.calltype{150}='stdcall'; fcns.LHS{150}='int16'; fcns.RHS{150}={'int16', 'int16', 'int16Ref', 'int16Ref', 'uint32', 'uint32', 'double'};
%  extern i16 _stdcall WFM_Rate ( f64 rate, i16 units, i16 * timebase, u32 * updateInterval); 
fcns.name{151}='WFM_Rate'; fcns.calltype{151}='stdcall'; fcns.LHS{151}='int16'; fcns.RHS{151}={'double', 'int16', 'int16Ref', 'uint32Ref'};
%  extern i16 _stdcall WFM_Scale ( i16 slot, i16 chan, u32 cnt, f64 gain, f64 * voltArray, i16 * binArray); 
fcns.name{152}='WFM_Scale'; fcns.calltype{152}='stdcall'; fcns.LHS{152}='int16'; fcns.RHS{152}={'int16', 'int16', 'uint32', 'double', 'doubleRef', 'int16Ref'};
%  extern i16 _stdcall AI_Read_Scan ( i16 slot, i16 * reading); 
fcns.name{153}='AI_Read_Scan'; fcns.calltype{153}='stdcall'; fcns.LHS{153}='int16'; fcns.RHS{153}={'int16', 'int16Ref'};
%  extern i16 _stdcall AI_VRead_Scan ( i16 slot, f64 * reading); 
fcns.name{154}='AI_VRead_Scan'; fcns.calltype{154}='stdcall'; fcns.LHS{154}='int16'; fcns.RHS{154}={'int16', 'doubleRef'};
%  extern i16 _stdcall SCXI_ModuleID_Read ( i16 scxiID, i16 moduleSlot, i32 * id); 
fcns.name{155}='SCXI_ModuleID_Read'; fcns.calltype{155}='stdcall'; fcns.LHS{155}='int16'; fcns.RHS{155}={'int16', 'int16', 'int32Ref'};
%  extern i16 _stdcall AO_VScale ( i16 slot, i16 chan, f64 voltage, i16 * value); 
fcns.name{156}='AO_VScale'; fcns.calltype{156}='stdcall'; fcns.LHS{156}='int16'; fcns.RHS{156}={'int16', 'int16', 'double', 'int16Ref'};
...
fcns.name{160}='WFM_Set_Clock'; fcns.calltype{160}='stdcall'; fcns.LHS{160}='int16'; fcns.RHS{160}={'int16', 'int16', 'uint32', 'double', 'uint32', 'doubleRef'};
%  extern i16 _stdcall DAQ_Set_Clock ( i16 slot, u32 whichClock, f64 desiredRate, u32 units, f64 * actualRate); 
fcns.name{161}='DAQ_Set_Clock'; fcns.calltype{161}='stdcall'; fcns.LHS{161}='int16'; fcns.RHS{161}={'int16', 'uint32', 'double', 'uint32', 'doubleRef'};
...
fcns.name{164}='DIG_In_Prt'; fcns.calltype{164}='stdcall'; fcns.LHS{164}='int16'; fcns.RHS{164}={'int16', 'int16', 'int32Ref'};
...
fcns.name{166}='AI_Get_Overloaded_Channels'; fcns.calltype{166}='stdcall'; fcns.LHS{166}='int16'; fcns.RHS{166}={'int16', 'int16Ref', 'int16Ref'};
...
fcns.name{168}='DIG_Change_Message_Config'; fcns.calltype{168}='stdcall'; fcns.LHS{168}='int16'; fcns.RHS{168}={'int16', 'int16', 'int8Ref', 'int8Ref', 'voidRef', 'int16', 'uint32'};
...
fcns.name{170}='DIG_Filter_Config'; fcns.calltype{170}='stdcall'; fcns.LHS{170}='int16'; fcns.RHS{170}={'int16', 'int16', 'int8Ref', 'double'};
%  extern i16 _stdcall SCXI_TerminalBlockID_Read ( i16 scxiID, i16 moduleSlot, i32 * id); 
fcns.name{171}='SCXI_TerminalBlockID_Read'; fcns.calltype{171}='stdcall'; fcns.LHS{171}='int16'; fcns.RHS{171}={'int16', 'int16', 'int32Ref'};
%  extern i16 _stdcall ni62xx_CalStart ( i16 device, i8 * password); 
fcns.name{172}='ni62xx_CalStart'; fcns.calltype{172}='stdcall'; fcns.LHS{172}='int16'; fcns.RHS{172}={'int16', 'int8Ref'};
%  extern i16 _stdcall ni62xx_CalAdjust ( i16 device, u32 calMode, f64 * measuredData, i16 numOfValues); 
fcns.name{173}='ni62xx_CalAdjust'; fcns.calltype{173}='stdcall'; fcns.LHS{173}='int16'; fcns.RHS{173}={'int16', 'uint32', 'doubleRef', 'int16'};
...
fcns.name{176}='CalFetchInternalReference'; fcns.calltype{176}='stdcall'; fcns.LHS{176}='int16'; fcns.RHS{176}={'int16', 'doubleRef'};
%  extern i16 _stdcall CalChangePassword ( i16 device, i8 * oldPassword, i8 * newPassword); 
fcns.name{177}='CalChangePassword'; fcns.calltype{177}='stdcall'; fcns.LHS{177}='int16'; fcns.RHS{177}={'int16', 'int8Ref', 'int8Ref'};
%  extern i16 _stdcall CalFetchCount ( i16 device, u32 calType, i32 * calCount); 
fcns.name{178}='CalFetchCount'; fcns.calltype{178}='stdcall'; fcns.LHS{178}='int16'; fcns.RHS{178}={'int16', 'uint32', 'int32Ref'};
%  extern i16 _stdcall CalFetchDate ( i16 device, u32 calType, i32 * year, i32 * month, i32 * day); 
fcns.name{179}='CalFetchDate'; fcns.calltype{179}='stdcall'; fcns.LHS{179}='int16'; fcns.RHS{179}={'int16', 'uint32', 'int32Ref', 'int32Ref', 'int32Ref'};
%  extern i16 _stdcall CalFetchTemperature ( i16 device, u32 calType, f64 * temperature); 
fcns.name{180}='CalFetchTemperature'; fcns.calltype{180}='stdcall'; fcns.LHS{180}='int16'; fcns.RHS{180}={'int16', 'uint32', 'doubleRef'};
%  extern i16 _stdcall CalFetchMiscInfo ( i16 device, i8 * miscInfo); 
fcns.name{181}='CalFetchMiscInfo'; fcns.calltype{181}='stdcall'; fcns.LHS{181}='int16'; fcns.RHS{181}={'int16', 'int8Ref'};
%  extern i16 _stdcall CalStoreMiscInfo ( i16 device, i8 * miscInfo); 
fcns.name{182}='CalStoreMiscInfo'; fcns.calltype{182}='stdcall'; fcns.LHS{182}='int16'; fcns.RHS{182}={'int16', 'int8Ref'};
%  extern i16 _stdcall Get_DAQ_Event ( u32 timeOut, i16 * handle, i16 * msg, i16 * wParam, i32 * lParam); 
fcns.name{183}='Get_DAQ_Event'; fcns.calltype{183}='stdcall'; fcns.LHS{183}='int16'; fcns.RHS{183}={'uint32', 'int16Ref', 'int16Ref', 'int16Ref', 'int32Ref'};
%  extern i16 _stdcall Peek_DAQ_Event ( u32 timeOut, i16 * handle, i16 * msg, i16 * wParam, i32 * lParam); 
fcns.name{184}='Peek_DAQ_Event'; fcns.calltype{184}='stdcall'; fcns.LHS{184}='int16'; fcns.RHS{184}={'uint32', 'int16Ref', 'int16Ref', 'int16Ref', 'int32Ref'};
%  extern i16 _stdcall REG_Level_Read ( i16 slot, i16 registerIndex, u32 * registerValue); 
fcns.name{185}='REG_Level_Read'; fcns.calltype{185}='stdcall'; fcns.LHS{185}='int16'; fcns.RHS{185}={'int16', 'int16', 'uint32Ref'};
%  extern i16 _stdcall REG_Level_Write ( i16 slot, i16 registerIndex, u32 bitsAffected, u32 bitSettings, u32 * registerValue); 
fcns.name{186}='REG_Level_Write'; fcns.calltype{186}='stdcall'; fcns.LHS{186}='int16'; fcns.RHS{186}={'int16', 'int16', 'uint32', 'uint32', 'uint32Ref'};
