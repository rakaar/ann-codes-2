function ES_trigPlay ( play, fs )
%
% Ed Smith, March 2009
%
% Set up the TDT RX6 to output a time series (audio stimulus)
...
if isempty ( RX6_gPL ) % First invocation?
    ...
    fh = figure ( 'Visible', 'off', 'Position', [2 2 21 21]);
    ...
    rcx_file_name = 'G:\MATLAB701\work\2p\TDT_files\ES_trigPlay.rcx';
...
% Reset the indexCntr and isDone module
% (ES_trigPlay.rcx has no explicit software triggered "RESET" function)
% invoke ( RX6_gPL, 'SoftTrg', 1 ); 

% Send the matlab audio vector to the RX6
