   function [finished_stim,OptoParams]=prairie_OptoAud_struct_sa(OptoParams,PP_handles)
...
modulate_time=0:1/HW.Fso2:fix(stim_structureOpto.stim_dur);
modulate_wav=square(2*pi*1000*modulate_time,82);
