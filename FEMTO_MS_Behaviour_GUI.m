function varargout = FEMTO_MS_Behaviour_GUI(varargin)
% FEMTO_MS_BEHAVIOUR_GUI MATLAB code for FEMTO_MS_Behaviour_GUI.fig
%      FEMTO_MS_BEHAVIOUR_GUI, by itself, creates a new FEMTO_MS_BEHAVIOUR_GUI or raises the existing
%      singleton*.
%
%      H = FEMTO_MS_BEHAVIOUR_GUI returns the handle to a new FEMTO_MS_BEHAVIOUR_GUI or the handle to
%      the existing singleton*.
%
%      FEMTO_MS_BEHAVIOUR_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FEMTO_MS_BEHAVIOUR_GUI.M with the given input arguments.
%
%      FEMTO_MS_BEHAVIOUR_GUI('Property','Value',...) creates a new FEMTO_MS_BEHAVIOUR_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FEMTO_MS_Behaviour_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FEMTO_MS_Behaviour_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help FEMTO_MS_Behaviour_GUI

% Last Modified by GUIDE v2.5 06-Nov-2019 19:15:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @FEMTO_MS_Behaviour_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @FEMTO_MS_Behaviour_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before FEMTO_MS_Behaviour_GUI is made visible.
function FEMTO_MS_Behaviour_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FEMTO_MS_Behaviour_GUI (see VARARGIN)

% Choose default command line output for FEMTO_MS_Behaviour_GUI
...
% UIWAIT makes FEMTO_MS_Behaviour_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FEMTO_MS_Behaviour_GUI_OutputFcn(hObject, eventdata, handles) 
