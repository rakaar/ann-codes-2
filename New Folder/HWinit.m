...
%HW.Fsi=50000; % analog input for triggers etc sampling frequency
...
HW.ai = analoginput('nidaq',HW.boardID2); % second board to acquire triggers DW==> ID2 for ephys
...
elseif casenum==6
    ...
    elseif frame_max_speed==1
        HW.ip_ch=addchannel(HW.ai,[3 1 2 6 7]);
    end
