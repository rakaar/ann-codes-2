function varargout = GPCTR_Control(varargin)
%GPCTR_CONTROL calls NI library with the appropriate arguments.
%
...
%	int16 GPCTR_Control(int16, uint32, uint32)
%
...
[varargout{1}]=calllib('NI','GPCTR_Control',varargin{:});
