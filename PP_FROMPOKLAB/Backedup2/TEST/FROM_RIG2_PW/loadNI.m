...
% Load the library.
%loadlibrary('G:\WINDOWS\system32\nidaq32.dll',@NI,'alias','NI');
loadlibrary('C:\WINDOWS\system32\nidaq32.dll',@NI,'alias','NI');

if nargout
	%param = loadNIcns('G:\Program Files\National Instruments\NI-DAQ\Include\nidaqcns.h');
	param = loadNIcns('C:\Program Files\National Instruments\NI-DAQ\Include\nidaqcns.h');
end
