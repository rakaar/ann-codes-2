...
% Last Modified by GUIDE v2.5 31-Mar-2019 17:05:49
...
if SSAPARAMS.use_sam==1
    ...
    if SSAPARAMS.use_MSt==1
        SSAPARAMS.use_MSt=0;
        set(handles.use_MSt,'Value',SSAPARAMS.use_MSt);
        set(handles.MSt_block,'BackgroundColor','white');
    end
else
...
%%% FOR MULTIPLE TONE STANDARDS

eval(sprintf('set(handles.MSt_Alow,''String'',''%i'');',SSAPARAMS.MSt_Alow))
set(handles.MSt_Alow,'Value',SSAPARAMS.MSt_Alow);
eval(sprintf('set(handles.MSt_Ahigh,''String'',''%i'');',SSAPARAMS.MSt_Ahigh))
set(handles.MSt_Ahigh,'Value',SSAPARAMS.MSt_Ahigh);
eval(sprintf('set(handles.MSt_nfreqsA,''String'',''%i'');',SSAPARAMS.MSt_nfreqsA))
set(handles.MSt_nfreqsA,'Value',SSAPARAMS.MSt_nfreqsA);
eval(sprintf('set(handles.MSt_Bstartpos,''String'',''%i'');',SSAPARAMS.MSt_Bstartpos))
set(handles.MSt_Bstartpos,'Value',SSAPARAMS.MSt_Bstartpos);
eval(sprintf('set(handles.MSt_numBs,''String'',''%i'');',SSAPARAMS.MSt_numBs))
set(handles.MSt_numBs,'Value',SSAPARAMS.MSt_numBs);
eval(sprintf('set(handles.MSt_freqB,''String'',''%i'');',SSAPARAMS.MSt_freqB))
set(handles.MSt_freqB,'Value',SSAPARAMS.MSt_freqB);
eval(sprintf('set(handles.MSt_B_A_int_dB,''String'',''%i'');',SSAPARAMS.MSt_B_A_int_dB))
set(handles.MSt_B_A_int_dB,'Value',SSAPARAMS.MSt_B_A_int_dB);

set(handles.use_MSt,'Value',SSAPARAMS.use_MSt);
if SSAPARAMS.use_MSt==1
    set(handles.MSt_block,'BackgroundColor',[1    0   0]);
    if SSAPARAMS.use_sam==1
        SSAPARAMS.use_sam=0;
        set(handles.use_sam,'Value',SSAPARAMS.use_sam);
        set(handles.samblock,'BackgroundColor','white');
...
% SSAPARAMS= rmfield(SSAPARAMS,'rand_stimB_loc');
if SSAPARAMS.randB_check==1&SSAPARAMS.rand_nstim_check==0&  SSAPARAMS.num_stimB==1
...
elseif SSAPARAMS.randB_check==1&SSAPARAMS.rand_nstim_check==0&  SSAPARAMS.num_stimB>1
    %         for nstimB=1:SSAPARAMS.num_stimB
    %             SSAPARAMS.rand_stimB_loc(nstimB,:)=fix((total_stims-4)*rand(1,treps))+5;
    %         end
    
    for nn=1:treps
        stp=0;
        while stp==0
            devlocs= randi(20,1,3)+4;
            if isempty(find(diff(sort(devlocs))<5))==1
                stp=1;
            end
            SSAPARAMS.rand_stimB_loc(:,nn)=devlocs;
        end
    end
    SSAPARAMS.rand_stimB_loc
end
...
SSAPARAMS.use_MSt=get(handles.use_MSt,'Value');
SSAPARAMS.MSt_Alow=get(handles.MSt_Alow,'Value');
SSAPARAMS.MSt_Ahigh=get(handles.MSt_Ahigh,'Value');
SSAPARAMS.MSt_nfreqsA=get(handles.MSt_nfreqsA,'Value');
SSAPARAMS.MSt_Bstartpos=get(handles.MSt_Bstartpos,'Value');
SSAPARAMS.MSt_numBs=get(handles.MSt_numBs,'Value');
SSAPARAMS.MSt_freqB=get(handles.MSt_freqB,'Value');
SSAPARAMS.MSt_B_A_int_dB=get(handles.MSt_B_A_int_dB,'Value');
...
function MSt_Alow_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_Alow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_Alow as text
%        str2double(get(hObject,'String')) returns contents of MSt_Alow as a double

load SSAPARAMS
SSAPARAMS.MSt_Alow=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_Alow,'Value',SSAPARAMS.MSt_Alow);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_Alow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_Alow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function MSt_Ahigh_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_Ahigh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_Ahigh as text
%        str2double(get(hObject,'String')) returns contents of MSt_Ahigh as a double

load SSAPARAMS
SSAPARAMS.MSt_Ahigh=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_Ahigh,'Value',SSAPARAMS.MSt_Ahigh);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_Ahigh_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_Ahigh (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function MSt_nfreqsA_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_nfreqsA (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_nfreqsA as text
%        str2double(get(hObject,'String')) returns contents of MSt_nfreqsA as a double

load SSAPARAMS
SSAPARAMS.MSt_nfreqsA=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_nfreqsA,'Value',SSAPARAMS.MSt_nfreqsA);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_nfreqsA_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_nfreqsA (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function MSt_Bstartpos_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_Bstartpos (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_Bstartpos as text
%        str2double(get(hObject,'String')) returns contents of MSt_Bstartpos as a double

load SSAPARAMS
SSAPARAMS.MSt_Bstartpos=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_Bstartpos,'Value',SSAPARAMS.MSt_Bstartpos);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_Bstartpos_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_Bstartpos (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function MSt_numBs_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_numBs (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_numBs as text
%        str2double(get(hObject,'String')) returns contents of MSt_numBs as a double

load SSAPARAMS
SSAPARAMS.MSt_numBs=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_numBs,'Value',SSAPARAMS.MSt_numBs);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_numBs_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_numBs (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function MSt_freqB_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_freqB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_freqB as text
%        str2double(get(hObject,'String')) returns contents of MSt_freqB as a double

load SSAPARAMS
SSAPARAMS.MSt_freqB=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_freqB,'Value',SSAPARAMS.MSt_freqB);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_freqB_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_freqB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in use_MSt.
function use_MSt_Callback(hObject, eventdata, handles)
% hObject    handle to use_MSt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of use_MSt

load SSAPARAMS
SSAPARAMS.use_MSt=get(hObject,'Value');
if SSAPARAMS.use_MSt==1
    set(handles.MSt_block,'BackgroundColor',[1    0    0]);
    if SSAPARAMS.use_sam==1
        SSAPARAMS.use_sam=0;
        set(handles.use_sam,'Value',0)
        set(handles.samblock,'BackgroundColor','white');
    end
else
    set(handles.MSt_block,'BackgroundColor','white');
...
function MSt_B_A_int_dB_Callback(hObject, eventdata, handles)
% hObject    handle to MSt_B_A_int_dB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MSt_B_A_int_dB as text
%        str2double(get(hObject,'String')) returns contents of MSt_B_A_int_dB as a double

load SSAPARAMS
SSAPARAMS.MSt_B_A_int_dB=str2double(get(hObject,'String')); %returns contents of num_pt_val as a double
set(handles.MSt_B_A_int_dB,'Value',SSAPARAMS.MSt_B_A_int_dB);
curdir=pwd;
cd C:\EXPERIMENTS\CODES\PARAMS
save SSAPARAMS SSAPARAMS
...
% --- Executes during object creation, after setting all properties.
function MSt_B_A_int_dB_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MSt_B_A_int_dB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
