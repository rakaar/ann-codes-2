...
%Prior to R13SP1, syntax was TypeRef, not TypePtr
v = version('-date');
v = datenum(v);
if v < 731797       % datenum for R13SP1
    fmt = 'uint32Ref';
end;

pulCount = libpointer(fmt,2^24-1-10);  %The number of events counted by the counter
